...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid nav-contents">
    ...
    <div class="auth-area-sp">
      <ul>
        <li><a href="/dashboard"><span class="username">（ユーザー名）</span></a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="logout-form" action="http://localhost:8555/logout" method="POST" class="d-none">
          <input type="hidden" name="_token" value="adTcou2ZWujA5zD5OB6xBhODwyUIoWs3nOD3F1U0" autocomplete="off">        </form>
      </div>
      <div class="modal-footer">
        <div class="user">
          <div class="avatar">
            ...
            <div class="username">（ユーザー名）<div class="uniqueidpostfix">@<span>VN80FF</span></div>
          </div>
        </div>
      </div>
    </div>
